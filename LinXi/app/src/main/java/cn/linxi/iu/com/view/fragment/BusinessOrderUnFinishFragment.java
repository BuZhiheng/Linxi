...
import cn.linxi.iu.com.adapter.BusinessOrdersUnfinishAdapter;
 ...
 */
public class BusinessOrderUnFinishFragment extends Fragment implements IBusinessHistoryOrderListView {
    ...
    private BusinessOrdersUnfinishAdapter adapter;
    ...
    private void initView() {
        ...
        adapter = new BusinessOrdersUnfinishAdapter(getContext());
