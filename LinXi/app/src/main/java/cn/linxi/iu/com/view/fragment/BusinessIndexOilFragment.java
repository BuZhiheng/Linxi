...
import cn.linxi.iu.com.presenter.BusinessIndexOilFrmPresenter;
 ...
 */
public class BusinessIndexOilFragment extends Fragment implements IBusinessIndexView, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_business_index_oil,container,false);
        ButterKnife.bind(this,view);
        presenter = new BusinessIndexOilFrmPresenter(this);
        initView();
        return view;
    }
