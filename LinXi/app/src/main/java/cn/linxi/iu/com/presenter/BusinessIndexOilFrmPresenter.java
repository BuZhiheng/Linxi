 ...
 */
public class BusinessIndexOilFrmPresenter implements IBusinessIndexOilFrmPresenter {
    private IBusinessIndexView view;
    public BusinessIndexOilFrmPresenter(IBusinessIndexView view){
        this.view = view;
    ...
    public void getData(String stime, String etime) {
        ...
        String url = HttpUrl.businessGetUser + OkHttpUtil.getSign()+"&operat_id="+operatId+"&stime="+stime+"&etime="+etime+"&type=0";
