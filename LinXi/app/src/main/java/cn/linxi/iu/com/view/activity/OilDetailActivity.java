...
import cn.linxi.iu.com.presenter.OilDetailPresenter;
 ...
 */
public class OilDetailActivity extends AppCompatActivity implements IOilDetailView{
    private IOilDetailPresenter presenter;
    ...
    private void initView() {
        presenter = new OilDetailPresenter(this);
        ((TextView)findViewById(R.id.tv_titlebar_title)).setText("油卡明细");
