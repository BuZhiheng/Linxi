...
import cn.linxi.iu.com.view.fragment.TransferOrderHistoryFragment;
import cn.linxi.iu.com.view.fragment.TransferOrderUnFinishFragment;
/**
 * Created by buzhiheng on 2016/8/4.
 * Desc 我的订单页面
 */
public class MyOrderTransferActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myorder_transfer);
        ButterKnife.bind(this);
        initView();
    }
    private void initView() {
        ((TextView)findViewById(R.id.tv_titlebar_title)).setText("转让明细");
        fragments = new ArrayList<>();
        fragments.add(new TransferOrderUnFinishFragment());
        fragments.add(new TransferOrderHistoryFragment());
