 ...
 */
public class StationDetailOilTypePresenter implements IStationDetailPresenter {
    private IStationDetatilView view;
    private String stationId;
    private AppCompatActivity context;
    private Intent intent;
    public StationDetailOilTypePresenter(IStationDetatilView view,AppCompatActivity context){
        this.view = view;
    ...
    public void commitOrder(StationOilType detail, String purchase) {
        ...
        RequestBody body = new FormBody.Builder()
                ...
                .add("apply", "normal")
                .add("order_id", "")//
                .add("gid", detail.details_id)
                .add("num",purchase)
                .add("stype","0")//油品/非油品(0/1)
