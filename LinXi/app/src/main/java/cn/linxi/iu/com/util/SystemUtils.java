...
public class SystemUtils {
    ...
    public static boolean networkState(){
        ConnectivityManager cm = (ConnectivityManager) (LXApplication.getCtx().getSystemService(Context.CONNECTIVITY_SERVICE));
    ...
    public static boolean isAvilibleApk(String packageName){
        //获取packagemanager
        final PackageManager packageManager = LXApplication.getCtx().getPackageManager();
        //获取所有已安装程序的包信息
