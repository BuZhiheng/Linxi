...
import cn.linxi.iu.com.view.fragment.OrderHistoryFragment;
import cn.linxi.iu.com.view.fragment.OrderUnFinishFragment;
/**
...
public class MyOrderActivity extends AppCompatActivity {
    ...
    private void initView() {
        ((TextView)findViewById(R.id.tv_titlebar_title)).setText("我的订单");
        fragments = new ArrayList<>();
        fragments.add(new OrderUnFinishFragment());
