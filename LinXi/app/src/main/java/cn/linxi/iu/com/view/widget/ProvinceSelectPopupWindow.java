...
public class ProvinceSelectPopupWindow extends PopupWindow {
    ...
    private View view;
    public ProvinceSelectPopupWindow(AppCompatActivity context){
        super(context);
        this.context = context;
        view = LayoutInflater.from(context).inflate(R.layout.dialog_select_province,null);
        ...
        view.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                int height = view.findViewById(R.id.ll_popwin_province).getTop();
